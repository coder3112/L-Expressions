...
This resulted in some promising results but the key part of storing things as a tree was structured such that only one top level expression could exist at a time. This meant more complex examples could not be solved.
